...
const en: Copy = {
  ...
  overseer: {
    ...
    overview: "Overseer is a cross-platform MRO system on web and mobile. It replaces paper work orders, logbooks, and inspection sheets with one connected workflow for MRO organizations, independent A&P mechanics, and fleet operators. Work orders, discrepancies, labor, compliance, inventory, and crew coordination all live in the same place.",
    stats: [
    ...
    industryBody: "Most general aviation and MRO documentation is still analog: handwritten work orders, paper logbooks, pencil-marked inspection sheets. Compliance, coordination, and customer updates all run through documents that get lost, misread, or never filed. Overseer replaces that stack of paper with one platform that travels with the aircraft.",
    ...
    decisions: [
      ...
      { n: "03", title: "Labor visibility for supervisors", body: "Hours are logged per sub-item, per technician. Supervisors see job progress in real time without walking the shop floor, and a client-ready labor report generates from the same data." },
    ...
    workOrder: {
      ...
      capabilities: [
        ...
        { name: "Hierarchical discrepancies", body: "Nested items and sub-items capture findings, estimated and actual hours, parts, action taken, and approval status per line." },
        { name: "Labor & cost reporting", body: "Hours logged per sub-item, per technician feed real-time progress views and auto-generated client-ready labor reports." },
    ...
    otherFeaturesIntro: "Beyond Work Order MX, I contributed design work across several other surfaces on the platform — including inventory management, parts purchasing, compliance views, cross-platform patterns, and dozens of smaller QoL improvements.",
    otherFeatures: [
      ...
      { name: "Inventory Management", body: "Users can remove equipment from an aircraft and add it to their organization's inventory for selling or repair." },
      { name: "Parts Purchased Inside Platform", body: "Users can browse other organizations' inventories and order parts directly from the platform." },
      ...
      { name: "Other small features & QoL", body: "Dozens of refinements across the platform — from field-level improvements to workflow tweaks that made daily tasks faster." },
    ],
    impactTitle: "impact",
...
const pt: Copy = {
  ...
  overseer: {
    ...
    decisions: [
      ...
      { n: "03", title: "Visibilidade de mão de obra para supervisores", body: "As horas são registradas por técnico no nível do subitem, dando ao supervisor uma visão em tempo real do progresso sem precisar caminhar pelo hangar — e um relatório de mão de obra pronto para o cliente é gerado automaticamente a partir desses dados." },
    ...
    workOrder: {
      ...
      capabilities: [
        ...
        { name: "Discrepâncias hierárquicas", body: "Itens e subitens aninhados registram achados, horas estimadas e reais, peças utilizadas, ação tomada e status de aprovação por linha." },
        { name: "Relatório de mão de obra e custos", body: "As horas registradas por técnico no nível do subitem alimentam tanto a visão de progresso em tempo real quanto relatórios prontos para o cliente, gerados automaticamente." },
    ...
    otherFeaturesIntro: "Além do Work Order MX, contribuí com design em várias outras superfícies da plataforma — incluindo gestão de estoque, compra de peças, views de compliance, padrões multiplataforma e dezenas de pequenas melhorias de qualidade de vida.",
    otherFeatures: [
      ...
      { name: "Gestão de estoque", body: "Os usuários podem remover equipamentos de uma aeronave e adicioná-los ao estoque da organização para venda ou reparo." },
      { name: "Compra de peças dentro da plataforma", body: "Os usuários podem consultar estoques de outras organizações e solicitar peças diretamente pela plataforma." },
      ...
      { name: "Outros recursos e melhorias de QoL", body: "Dezenas de refinamentos em toda a plataforma — desde melhorias em campos até ajustes de fluxo que tornaram tarefas diárias mais rápidas." },
    ],
    impactTitle: "impacto",
