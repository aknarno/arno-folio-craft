...
import overseerDetail from "@/assets/overseer/work-order-detail-v6.png.asset.json";
...
@media (max-width: 640px) {
  ...
  .nav-left { flex-direction: column; align-items: flex-start; gap: 0.4rem; min-width: 0; flex: 1 1 auto; }
